...
public class AuthorizationSecurityConfig {
    ...
    public RegisteredClientRepository clientRepository() {
        ...
        RegisteredClient gateway = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .redirectUri("http://127.0.0.1:8002/login/oauth2/code/gateway")
                .redirectUri("http://127.0.0.1:8002/authorized")
    ...
    public ProviderSettings providerSettings() {
        return ProviderSettings.builder().issuer("http://127.0.0.1:8001").build();
    }
