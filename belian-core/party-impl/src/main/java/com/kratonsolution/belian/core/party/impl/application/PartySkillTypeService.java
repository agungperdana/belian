...
import com.kratonsolution.belian.core.party.impl.orm.PartySkillType;
import com.kratonsolution.belian.core.party.impl.repository.PartySkillTypeRepository;
...
public class PartySkillTypeService
{
	...
	public PartySkillType findById(String id)
	{
