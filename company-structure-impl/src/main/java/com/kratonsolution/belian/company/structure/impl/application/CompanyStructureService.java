...
package com.kratonsolution.belian.company.structure.impl.application;
...
import com.kratonsolution.belian.company.structure.impl.repository.CompanyStructureRepository;
...
{	
	...
	public CompanyStructure getOne(String id)
	{
	...
	{
		return repository.getOneByOrganizationId(organization);
	}
