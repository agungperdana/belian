...
public class PatientProviderRelationshipService extends AbstractService
{
	...
	@Secured("ROLE_PATIENT_READ")
	public PatientProviderRelationship getOne(String id)
	{
	...
	public void add(Date start,String code,String name,Date birthDate,Gender gender)
	{
		...
		if(person != null)
		{
			...
			if(relationship == null)
			{
				...
				relationship.setFromRole(roleRepo.getOne(patient.getId()));
	...
	{
		Person person = personService.getOne(patient.getFromParty().getCode());
		if(person != null)
		{
