 ...
 */
public class TransferOrderRequestFormContent extends FormContent
{	
	...
	public TransferOrderRequestFormContent()
	{
		super();
		initToolbar();
		initForm();
	...
	{
		number.setText(TransferOrderRequest.NCODE+System.currentTimeMillis());
