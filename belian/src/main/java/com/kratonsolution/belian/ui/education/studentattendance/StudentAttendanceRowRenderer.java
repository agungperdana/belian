 ...
 */
public class StudentAttendanceRowRenderer implements RowRenderer<StudentAttendance>
{
	private Language lang = Springs.get(Language.class);
	
	@Override
	public void render(Row row, StudentAttendance data, int index) throws Exception
	{
		if(data != null)
		{
