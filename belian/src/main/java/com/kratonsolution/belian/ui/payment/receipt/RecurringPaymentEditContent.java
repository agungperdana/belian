 ...
 */
public class RecurringPaymentEditContent extends FormContent
{	
	...
	public RecurringPaymentEditContent(Row row)
	{
		super();
		this.row = row;
		initToolbar();
	...
	public void initToolbar()
	{
		toolbar.getCancel().addEventListener(Events.ON_CLICK,new EventListener<Event>()
		{
			...
			{
				Flow.next(getParent(),new RecurringPaymentGridContent());
			}
		});
