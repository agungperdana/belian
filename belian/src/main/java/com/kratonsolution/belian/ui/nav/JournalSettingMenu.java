...
import com.kratonsolution.belian.ui.accounting.journalsetting.JournalSettingWindow;
 ...
 */
public class JournalSettingMenu extends Listitem
{
	private Language language = Springs.get(Language.class);
	
	public JournalSettingMenu()
	{
		init();
	}
