...
{	
	...
	protected void initFinancial(Map<String,Boolean> modules)
	{
		...
		if(modules.containsKey("ROLE_GENERAL_LEDGER_REPORT_READ"))
			list.appendChild(new GeneralLedgerMenu());
		if(modules.containsKey("ROLE_TRIAL_BALANCE_REPORT_READ"))
			list.appendChild(new TrialBalanceMenu());
	...
	protected void initPharmacy(Map<String,Boolean> modules)
	{
		...
		if(modules.containsKey("ROLE_SIMPLE_PHARMACY_INVOICE_READ"))
			list.appendChild(new SimplePharmacyInvoiceMenu());
	...
	protected void initClinic(Map<String,Boolean> modules)
	{
		...
		if(modules.containsKey("ROLE_CLINIC_SALES_READ"))
			list.appendChild(new DoctorIncomeReportMenu());
