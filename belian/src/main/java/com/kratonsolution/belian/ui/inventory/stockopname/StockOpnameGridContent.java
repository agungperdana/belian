 ...
 */
public class StockOpnameGridContent extends GridContent
{
	private StockOpnameService service = Springs.get(StockOpnameService.class);
	
	private SessionUtils utils = Springs.get(SessionUtils.class);
	
	public StockOpnameGridContent()
	{
		super();
		initToolbar();
		initGrid();
	...
	protected void initToolbar()
	{
		...
		gridToolbar.getRefresh().addEventListener(Events.ON_CLICK,new EventListener<Event>()
		{
			...
			public void onEvent(Event event) throws Exception
			{
				...
				refresh(new StockOpnameModel(utils.getRowPerPage()));
			}
		});
	...
	{
		final StockOpnameModel model = new StockOpnameModel(utils.getRowPerPage());
		
		grid.setHeight("80%");
		grid.setEmptyMessage("No goods receive data exist.");
		grid.setModel(model);
		grid.setRowRenderer(new StockOpnameRowRenderer());
