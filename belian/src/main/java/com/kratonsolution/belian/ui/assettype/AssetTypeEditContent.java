 ...
 */
public class AssetTypeEditContent extends FormContent
{	
	...
	public AssetTypeEditContent(Facility facility)
	{
		super();
	...
	public void initToolbar()
	{
		...
		child.addEventListener(Events.ON_CLICK,new EventListener<Event>()
			...
			public void onEvent(Event event) throws Exception
			{
				Center canvas = (Center)AssetTypeEditContent.this.getParent();
				if(canvas != null)
				{
					AssetTypeFormContent form = new AssetTypeFormContent(facility);
