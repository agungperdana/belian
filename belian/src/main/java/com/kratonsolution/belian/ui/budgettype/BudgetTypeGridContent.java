 ...
 *
 */
public class BudgetTypeGridContent extends GridContent
{
	private final BudgetTypeService service = Springs.get(BudgetTypeService.class);
	
	public BudgetTypeGridContent()
	{
		super();
		initToolbar();
		initGrid();
	...
	protected void initToolbar()
	{
		...
		gridToolbar.getRefresh().addEventListener(Events.ON_CLICK,new EventListener<Event>()
		{
			...
			public void onEvent(Event event) throws Exception
			{
				...
				grid.setModel(new BudgetTypeModel(8));
			}
		});
	...
	{
		final BudgetTypeModel model = new BudgetTypeModel(8);
		
		grid.setParent(this);
		grid.setHeight("80%");
		grid.setEmptyMessage("No Budget Type data exist.");
		grid.setModel(model);
		grid.setRowRenderer(new BudgetTypeRowRenderer());
