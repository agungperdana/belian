...
public class PharmacySalesGridContent extends GridContent
{
	...
	protected void initToolbar()
	{
		...
		gridToolbar.getRefresh().addEventListener(Events.ON_CLICK,new EventListener<Event>()
		{
			...
			public void onEvent(Event event) throws Exception
			{
				...
				grid.setModel(new PharmacySalesModel(utils.getRowPerPage()));
				refresh(new PharmacySalesModel(utils.getRowPerPage()));
			}
		});
	...
	{
		final PharmacySalesModel model = new PharmacySalesModel(utils.getRowPerPage());
