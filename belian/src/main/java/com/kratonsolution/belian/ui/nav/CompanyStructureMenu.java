...
import com.kratonsolution.belian.ui.general.companystructure.CompanyStructureWindow;
 ...
 */
public class CompanyStructureMenu extends Listitem
{
	...
	public void init()
	{
		setLabel(language.get("navbar.menu.general.companystructure"));
