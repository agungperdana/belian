...
{
	@Query("FROM PharmacySales med WHERE med.organization.id =:company ORDER BY med.date DESC")
	public List<PharmacySales> findAll(Pageable pageable,@Param("company")String company);
	...
	public List<PharmacySales> findAllPaid(@Param("date")Date date,@Param("company")String company);
	...
	@Query("SELECT COUNT(med) FROM PharmacySales med WHERE med.organization.id =:company")
	...
	@Query("FROM PharmacySales med WHERE "
			...
			+ "AND med.date =:date "
			+ "ORDER BY med.date DESC")
	public List<PharmacySales> findAllPaidRegistered(@Param("date")Date date,@Param("company")String company);
}
