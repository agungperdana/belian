...
{	
	private static final long serialVersionUID = 8141002671441559841L;
	...
	public static Label label(BigDecimal decimal)
	{
		...
		label.setValue(NumberHelper.format(decimal));
	...
	{
		return new Listitem(NumberHelper.format(decimal), decimal);
	}
	...
	public static final Label blueNumeric(BigDecimal value)
	{
		...
		if(value != null)
			label.setValue(NumberHelper.format(value));
