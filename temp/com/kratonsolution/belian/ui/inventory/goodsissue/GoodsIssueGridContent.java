...
public class GoodsIssueGridContent extends GridContent
{
	...
	protected void initToolbar()
	{
		...
		gridToolbar.getRefresh().addEventListener(Events.ON_CLICK,new EventListener<Event>()
		{
			...
			public void onEvent(Event event) throws Exception
			{
				...
				refresh(new GoodsIssueModel(utils.getRowPerPage()));
			}
		});
	...
	{
		final GoodsIssueModel model = new GoodsIssueModel(utils.getRowPerPage());
		
		grid.setHeight("80%");
		grid.setEmptyMessage("No goods issue data exist.");
		grid.setModel(model);
		grid.setRowRenderer(new GoodsIssueRowRenderer());
		...
		grid.getColumns().appendChild(new Column("Company",null,"125px"));
