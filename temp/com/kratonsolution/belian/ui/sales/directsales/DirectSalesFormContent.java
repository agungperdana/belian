...
import com.kratonsolution.belian.sales.dm.CashSalesType;
 ...
 */
public class DirectSalesFormContent extends FormContent implements ProductPriceSelectionListener
{	
	...
	public void initToolbar()
	{
		...
		toolbar.getSave().addEventListener(Events.ON_CLICK,new EventListener<Event>()
		{
			...
			public void onEvent(Event event) throws Exception
			{
				...
				sales.setType(CashSalesType.DIRECT);
				...
				PrintWindow window = new PrintWindow(BillablePrint.GEN(sales.getId(),true),true);
				window.setPage(getPage());
				window.setVisible(true);
				
				Flow.next(getParent(), new DirectSalesGridContent());
			}
		});
	}
	...
	private void initItems()
	{
		...
		toolbar.getChildren().get(0).addEventListener(Events.ON_CLICK,new EventListener<Event>()
		{
			...
			public void onEvent(Event event) throws Exception
			{
				...
				row.addProductPriceListener(DirectSalesFormContent.this);
