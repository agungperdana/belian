...
public class MedicalSalesRow extends Row implements HasAmount
{
	...
	public ClinicSalesItem getMedicationItem()
	{
	...
	private class Listener implements EventListener<Event>
	{
		...
		public void onEvent(Event event) throws Exception
		{
			if(event instanceof InputEvent)
			{
				...
				for(Product product:productRepository.findAllMedical(DateTimes.currentDate(),input.getValue(),IndustrySegmentation.MEDICAL,ProductType.FINISH_GOODS))
				{
