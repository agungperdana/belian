...
public class ShipmentService extends AbstractService
{
	...
	public void addItem(ShipmentItem shipmentItem)
	{
		...
		{
			OrderItem out = orderItemRepository.getOne(order.getOrderItem().getId());
			if(out != null)
			{
	...
	public void deleteItem(Shipment shipment,Collection<String> itemIds)
	{
		...
		{
			Shipment out = repository.getOne(shipment.getId());
			if(out != null)
			{
	...
	{
		Shipment shipment = repository.getOne(id);
		if(shipment != null)
		{
	...
	public Shipment fromOrder(Order order,ShipmentType type,ShipmentStatusType lastStatus)
	{
		...
		//sender
		Party sender = partyRepo.getOne(order.getPartyTakingOrder().getId());
		if(sender != null)
		{
