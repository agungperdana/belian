...
public class EmploymentService extends AbstractService
{
	...
	public Employment getOne(String id)
	{
	...
	public void add(Date start,Date end,IDValueRef person,IDValueRef company)
	{
		...
		if(employer == null)
		{
			...
			employer.setEnd(end);
			employer.setParty(partyRepo.getOne(company.getId()));
		...
		if(employee == null)
		{
			...
			employee.setEnd(end);
			employee.setParty(partyRepo.getOne(person.getId()));
			employee.setType(PartyRoleType.EMPLOYEE);
			
			employeeRepo.save(employee);
		}
		
		Party owner = partyRepo.getOne(person.getId());
		if(owner != null)
		{
			...
			employment.setToParty(partyRepo.getOne(company.getId()));
	...
	public void delete(String id)
	{
		...
		{
			Employment emp = repository.getOne(id);
			if(emp != null)
			{
