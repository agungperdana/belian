 ...
 */
@Setter
public class PurchaseInvoiceBox extends AbstractCombobox<Invoice> implements Observer
{
	private PurchaseInvoiceService service = Springs.get(PurchaseInvoiceService.class);
	
	private String customer;

	public PurchaseInvoiceBox(boolean showCreateLink)
	{
		this(showCreateLink,false,null);
	}

	public PurchaseInvoiceBox(boolean showCreateLink,boolean fullspan)
	{
		this(showCreateLink,fullspan,null);
	}

	public PurchaseInvoiceBox(boolean showCreateLink,boolean fullspan,Invoice invoice)
	{
