 ...
 */
public class WorkRequirementRowRenderer implements RowRenderer<WorkRequirement>
{
	private SessionUtils utils = Springs.get(SessionUtils.class);
	
	@Override
	public void render(Row row, WorkRequirement data, int index) throws Exception
	{
		if(data != null)
		{
