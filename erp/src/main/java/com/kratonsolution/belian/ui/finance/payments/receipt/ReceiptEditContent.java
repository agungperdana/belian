 ...
 */
public class ReceiptEditContent extends AbstractForm
{	
	...
	public void initToolbar()
	{
		...
		toolbar.getPrint().addEventListener(Events.ON_CLICK, new EventListener<Event>()
		{
			...
			{
				PrintWindow print = new PrintWindow("/receiptprint?id="+RowUtils.id(row));
	...
	{
		Receipt receipt = service.getOne(RowUtils.id(row));
		if(receipt != null)
		{
