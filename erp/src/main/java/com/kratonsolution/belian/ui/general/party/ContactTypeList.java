...
import com.kratonsolution.belian.core.party.impl.orm.ContactType;
 ...
 */
public class ContactTypeList extends Listbox
{
	private SessionUtils utils = Springs.get(SessionUtils.class);
	
	private Map<String,ContactType> maps = new HashMap<String, ContactType>();
	
	public ContactTypeList(boolean fullspan)
	{
		this(fullspan,null);
	}
	
	public ContactTypeList(boolean fullspan,ContactType con)
	{
		if(fullspan)
			setWidth("100%");
		else
