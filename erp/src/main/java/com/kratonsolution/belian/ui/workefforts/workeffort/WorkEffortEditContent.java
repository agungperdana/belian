...
{	
	...
	public void initToolbar()
	{
		...
		toolbar.getSave().addEventListener(Events.ON_CLICK,new EventListener<Event>()
		{
			...
			public void onEvent(Event event) throws Exception
			{
				...
				WorkEffort effort = service.getOne(RowUtils.id(row));
				if(effort != null)
				{
	...
	private void initWorkRequirements()
	{
		...
		if(effort != null)
		{
			...
			{
				WorkRequirement work = workRequirementService.getOne(fill.getWorkRequirement().getId());
				if(work != null)
				{
					Row row = new Row();
	...
	private void initWorkOrders()
	{
		...
		if(effort != null)
		{
			...
			{
				OrderItem item = orderItemService.getOne(fill.getOrderItem().getId());
				if(item != null)
				{
					Row row = new Row();
