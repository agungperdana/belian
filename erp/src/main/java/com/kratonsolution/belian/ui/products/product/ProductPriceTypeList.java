 ...
 */
public class ProductPriceTypeList extends Listbox
{
	private SessionUtils utils = Springs.get(SessionUtils.class);
	
	private Map<String,PriceComponentType> maps = new HashMap<String, PriceComponentType>();
	
	public ProductPriceTypeList(boolean fullspan)
	{
		this(fullspan,null);
	}
	
	public ProductPriceTypeList(boolean fullspan,PriceComponentType con)
	{
		if(fullspan)
			setWidth("100%");
		else
