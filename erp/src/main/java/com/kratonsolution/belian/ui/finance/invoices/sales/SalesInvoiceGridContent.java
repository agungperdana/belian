 ...
 */
public class SalesInvoiceGridContent extends GridContent
{
	private SalesInvoiceService service = Springs.get(SalesInvoiceService.class);
	
	public SalesInvoiceGridContent()
	{
		super();
		initToolbar();
		initGrid();
	...
	protected void initToolbar()
	{
		...
		toolbar.getNew().addEventListener(Events.ON_CLICK,new EventListener<Event>()
		{
			...
			public void onEvent(Event event) throws Exception
			{
				Flow.next(getParent(), new SalesInvoiceFormContent());
			}
		});
	...
	{
		final SalesInvoiceModel model = new SalesInvoiceModel(utils.getRowPerPage());
		...
		grid.setModel(model);
		grid.setRowRenderer(new SalesInvoiceRenderer());
