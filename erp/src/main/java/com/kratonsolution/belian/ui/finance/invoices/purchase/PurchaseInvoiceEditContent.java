 ...
 */
public class PurchaseInvoiceEditContent extends AbstractForm
{	
	...
	public PurchaseInvoiceEditContent(Row row)
	{
		super();
		this.row = row;
		initToolbar();
	...
	public void initToolbar()
	{
		...
		toolbar.getPrint().addEventListener(Events.ON_CLICK, new EventListener<Event>()
		{
			...
			{
				PrintWindow print = new PrintWindow("/purchaseinvoiceprint?id="+RowUtils.id(row));
		...
		toolbar.getSave().addEventListener(Events.ON_CLICK,new EventListener<Event>()
		{
			...
			public void onEvent(Event event) throws Exception
			{
				PurchaseInvoice invoice = service.getOne(RowUtils.id(row));
	...
	private void initItems()
	{
		...
		nrc.getNew().addEventListener(Events.ON_CLICK, new EventListener<Event>()
		{
			...
			public void onEvent(Event arg0) throws Exception
			{
				Flow.next(getParent(), new PurchaseInvoiceItemForm(service.getOne(RowUtils.id(row))));
			}
		});
