...
public class PractitionerProviderRelationshipService extends AbstractService
{
	...
	@Secured("ROLE_PRACTITIONER_READ")
	public PractitionerProviderRelationship getOne(String id)
	{
	...
	public void add(Date start, String code, String name, Date birthDate, Gender gender)
	{
		 ...
		 */
		Person person = personService.getOne(code,name,birthDate,gender);
		if(person != null)
		{
			/**
			...
			if(relationship == null)
			{
				...
				relationship.setFromRole(roleRepo.getOne(practitioner.getId()));
	...
	{
		Person person = personService.getOne(practitioner.getFromParty().getCode());
		if(person != null)
		{
