...
public class NumberGenerator
{
	...
	public String generate(Date date,String organization,Code code)
	{
		...
		SequenceNumber number = repository.getOneByCompanyIdAndDateAndCode(organization,date,code);
		if(number == null)
		{
	...
	public int nextQueue(Code code)
	{
		...
		SequenceNumber sequence = repository.getOneByCompanyIdAndDateAndCode(utils.getOrganization().getId(), DateTimes.currentDate(), code);
		if(sequence == null)
		{
