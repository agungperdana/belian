...
public class QuickLaunchService
{
	...
	public QuickLaunch getOne(String id)
	{
	...
	@Secured({"ROLE_SYSTEM_READ"})
	public QuickLaunch getOneByNameAndUsername(String name,String username)
	{
		return repository.getOneByNameAndUsername(name, username);
	}
